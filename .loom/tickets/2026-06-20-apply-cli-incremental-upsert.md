...
- Depends on plan CLI, local state store, and artifact hash verification.
- Exact turbopuffer SDK behavior for generic schema should be verified before live approval.
