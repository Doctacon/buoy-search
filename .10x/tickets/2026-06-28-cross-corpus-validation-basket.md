...
- 2026-06-28: Discovered current 50 KiB repo file cap skips some central source files in pytest and Typer plans; seed labels avoid skipped files for now. Follow-up owner: `.10x/tickets/2026-06-28-repo-oversize-source-indexing.md`.
