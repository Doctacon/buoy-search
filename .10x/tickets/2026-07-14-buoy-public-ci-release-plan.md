...
Ship truthful public-project badges/governance, reproducible CI, and an approval-gated GitHub-only v0.2.0 release. This is a parent plan and is not executable.

## Governing records

- `.10x/decisions/github-only-release-automation.md`
...
3. `.10x/tickets/2026-07-14-publish-buoy-rebrand-commit.md` — reconcile inherited index, commit, push, and observe main CI.
4. `.10x/tickets/2026-07-14-create-buoy-v0-2-0-github-release.md` — configure release approval, tag, approve, and verify GitHub Release/artifacts/attestation.
...
- `v0.2.0` exists as a GitHub Release with wheel/sdist and provenance after explicit environment approval.
...
- None. Child tickets own execution blockers.
