...
This specification implements `.10x/decisions/superseded/production-routing-local-catalog.md`. It does not make the catalog an authorization system, remote namespace registry, taxonomy, graph, or source of truth for Turbopuffer contents.
