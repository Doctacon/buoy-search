...
- Live `retrieve`, live evals, and autoresearch/eval runtime configuration MUST accept `--embedding-precision` and `TURBO_SEARCH_EMBEDDING_PRECISION`. Their default remains `float32`.
